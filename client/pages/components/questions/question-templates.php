<template id="single-question-template">
	<div class="question-block single-type" data-type="single">
		...
		<div class="question-number-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
			<div>
		...
		<div class="options-container">
			...
			<div class="option-item"><input type="radio" class="correct-radio" value="A"><span>A.</span><input type="text" class="form-control option-content" placeholder="Đáp án A" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án A" rows="2"></textarea></div>
			<div class="option-item"><input type="radio" class="correct-radio" value="B"><span>B.</span><input type="text" class="form-control option-content" placeholder="Đáp án B" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án B" rows="2"></textarea></div>
			<div class="option-item"><input type="radio" class="correct-radio" value="C"><span>C.</span><input type="text" class="form-control option-content" placeholder="Đáp án C" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án C" rows="2"></textarea></div>
			<div class="option-item"><input type="radio" class="correct-radio" value="D"><span>D.</span><input type="text" class="form-control option-content" placeholder="Đáp án D" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án D" rows="2"></textarea></div>
...
<template id="sub-question-template">
	<div class="sub-question-item">
		...
		<div class="question-main-section" style="margin-bottom: 10px;">
		...
		<div class="sub-options-grid">
			<div class="sub-option"><input type="radio" class="correct-radio" value="A" required><span>A.</span><input type="text" class="form-control option-content" placeholder="Đáp án A" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án A" rows="2"></textarea></div>
			<div class="sub-option"><input type="radio" class="correct-radio" value="B" required><span>B.</span><input type="text" class="form-control option-content" placeholder="Đáp án B" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án B" rows="2"></textarea></div>
			<div class="sub-option"><input type="radio" class="correct-radio" value="C" required><span>C.</span><input type="text" class="form-control option-content" placeholder="Đáp án C" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án C" rows="2"></textarea></div>
			<div class="sub-option"><input type="radio" class="correct-radio" value="D" required><span>D.</span><input type="text" class="form-control option-content" placeholder="Đáp án D" required><textarea class="form-control option-translation" placeholder="Dịch / ghi chú đáp án D" rows="2"></textarea></div>
		</div>
		<div class="explanation-section">
			<label style="font-weight: 600; display: block; margin-top: 15px; margin-bottom: 5px;">Giải thích (Tùy chọn)</label>
			<textarea class="form-control explanation" placeholder="Giải thích đáp án..." rows="2"></textarea>
