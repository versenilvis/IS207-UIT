...
(6, 'C', 'Car insurance'),
(6, 'D', 'A GPS system');
-- CHÈN TIẾP 10 BÀI TEST MỚI
INSERT INTO `attempts` (`uuid`, `user_id`, `test_id`, `listening_correct`, `reading_correct`, `listening_score`, `reading_score`, `total_score`, `time_spent`, `created_at`) VALUES
-- Bài 6 (làm Test 1): 850 điểm, 115 phút
(UUID(), 2, 1, 88, 82, 440, 410, 850, 115, '2026-03-25 09:00:00'),

-- Bài 7 (làm Test 2): 725 điểm, 128 phút
(UUID(), 2, 2, 70, 75, 350, 375, 725, 128, '2026-04-05 14:00:00'),

-- Bài 8 (làm Test 1): 960 điểm, 110 phút
(UUID(), 2, 1, 94, 92, 485, 475, 960, 110, '2026-04-10 19:30:00'),

-- Bài 9 (làm Test 2): 625 điểm, 135 phút
(UUID(), 2, 2, 60, 65, 300, 325, 625, 135, '2026-04-18 20:00:00'),

-- Bài 10 (làm Test 1): 990 điểm, 105 phút (Max điểm)
(UUID(), 2, 1, 98, 97, 495, 495, 990, 105, '2026-04-28 08:15:00'),

-- Bài 11 (làm Test 2): 865 điểm, 122 phút
(UUID(), 2, 2, 85, 88, 425, 440, 865, 122, '2026-05-02 15:45:00'),

-- Bài 12 (làm Test 1): 790 điểm, 126 phút
(UUID(), 2, 1, 78, 80, 390, 400, 790, 126, '2026-05-05 10:20:00'),

-- Bài 13 (làm Test 2): 915 điểm, 119 phút
(UUID(), 2, 2, 91, 89, 470, 445, 915, 119, '2026-05-08 16:30:00'),

-- Bài 14 (làm Test 1): 830 điểm, 121 phút
(UUID(), 2, 1, 82, 84, 410, 420, 830, 121, '2026-05-11 09:45:00'),

-- Bài 15 (làm Test 2): 975 điểm, 114 phút
(UUID(), 2, 2, 95, 94, 490, 485, 975, 114, '2026-05-16 19:00:00');
